-- Define a custom enumeration type 'account_type' with three possible values: 'Client', 'Employee', and 'Admin'
CREATE TYPE public.account_type AS ENUM
    ('Client', 'Employee', 'Admin');

-- Change the owner of the 'account_type' enumeration type to 'cse340'
ALTER TYPE public.account_type
    OWNER TO cse340;

-- Table structure fot table `classification`
